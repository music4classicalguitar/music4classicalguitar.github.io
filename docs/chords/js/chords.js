...
function addCanvas() {
	...
	vl = canvas.width-3*borderwidth, l = vl / (1 - Math.pow(p,-15))
...
function setStringNote(str, pos, color) {
	var r = 5;
	var x = offset+l*(1-Math.pow(p,-pos))-2*r;
