class ScorePlayer {
	...
	load() {
		...
		// load audio
		let _this = this;
		this.scoreAudio = new Audio(this.score_name+'.mp3');
		this.scoreAudio.onerror = (e) => {
			this.score_player.innerHTML = 'Audio error: '+this.scoreAudio.currentSrc;
		};
		this.scoreAudio.oncanplaythrough = (event) => {
			if (_this.scoreAudio.readyState >= 3 && _this.scoreAudio.duration !== Infinity) {
